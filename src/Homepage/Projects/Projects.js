...
import modalpro2 from '../../assets/modal/modalpro2.png'
import modalGear from '../../assets/modal/modalGear.png'
import './project.css'
...
const Projects = () => {
    ...
    return (
        <div class='bg-[#CDF0EA] pb-10'>
            <h2 class='text-4xl ml-10 mb-10 pt-10' id='projects'>PROJECTS</h2>
                                    ...
                                    <CardGroup>
                                        <Card>
                                            ...
                                            <div class='flex justify-around'>
                                                ...
                                                <div>
                                                    <a href={"https://github.com/DevWithShakil/Developer-Portfolio"} target="_blank" rel="noopener noreferrer" download className='btn btn-primary'>SOURCE CODE</a>
                                                </div>
                                            </div>
                                        </Card>
                                    </CardGroup>
                                    <div class="modal-action">
                                        <label for="my-modal-5" class="btn modal-button">Go Back</label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-actions gap-10 pt-5">
                            ...
                            <div class="modal">
                                <div class="modal-box w-full h-full ">
                                    ...
                                    <CardGroup>
                                        <Card>
                                            <Card.Img variant="top" src={modalpro2} />
                                            <Card.Body>
                                                <Card.Title>Features</Card.Title>
                                                <Card.Text>
                                                    <ul class='text-left'>
                        ...
                        <div class="card-actions gap-10 pt-5">
                            ...
                            <div class="modal">
                                <div class="modal-box w-full h-full ">
                                    ...
                                    <CardGroup>
                                        <Card>
                                            <Card.Img variant="top" src={modalGear} />
                                            <Card.Body>
                                                <Card.Title>Features</Card.Title>
                                                <Card.Text>
                                                    <ul class='text-left'>
